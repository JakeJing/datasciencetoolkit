...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, boxrule=0pt, frame hidden, sharp corners, colback={codebgcolor}, borderline west={3pt}{0pt}{shadecolor}, breakable]}{\end{tcolorbox}}\fi
\makeatother
