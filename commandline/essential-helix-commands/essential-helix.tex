...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, breakable, enhanced, sharp corners, frame hidden, colback={codebgcolor}, boxrule=0pt]}{\end{tcolorbox}}\fi
\makeatother
