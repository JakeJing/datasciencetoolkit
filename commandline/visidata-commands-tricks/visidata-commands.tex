...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, breakable, frame hidden, borderline west={3pt}{0pt}{shadecolor}, colback={codebgcolor}, boxrule=0pt, enhanced]}{\end{tcolorbox}}\fi
\makeatother
