...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, enhanced, colback={codebgcolor}, frame hidden, breakable, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
