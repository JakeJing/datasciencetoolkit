...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, colback={codebgcolor}, borderline west={3pt}{0pt}{shadecolor}, frame hidden, sharp corners, breakable, enhanced]}{\end{tcolorbox}}\fi
\makeatother
