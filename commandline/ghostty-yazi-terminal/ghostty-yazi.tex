...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, frame hidden, boxrule=0pt, sharp corners, colback={codebgcolor}, breakable, enhanced]}{\end{tcolorbox}}\fi
\makeatother
