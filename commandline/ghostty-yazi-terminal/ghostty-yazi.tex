...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, breakable, borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt, colback={codebgcolor}, frame hidden, enhanced]}{\end{tcolorbox}}\fi
\makeatother
